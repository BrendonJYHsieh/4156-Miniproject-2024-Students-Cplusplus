...
1. Obtain the following libraries:
   - Crow-1.2.0-Darwin
   - boost_1_85_0

2. Place both libraries in the `external_libraries` directory.
...
# Set BASE_PATH
BASE_PATH="${1:-$HOME/test/4156-Miniproject-2024-Students-Cplusplus/IndividualMiniprojectC++}"
